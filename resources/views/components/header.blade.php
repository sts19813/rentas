    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/cotizacion">Cotizacion</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="configuracionesDropdown">
                        <li><a class="dropdown-item" href="/amenidades">Amenidades</a></li>
                        <li><a class="dropdown-item" href="/servicios">Servicio</a></li>
                    </ul>
                </li>
            </ul>
            <div class="d-flex">
